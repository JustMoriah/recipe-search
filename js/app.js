function iniciarApp() {
    ...
    function mostrarRecetaModal(receta) {
        ...
        modalBody.innerHTML = `
            ...
            <p>${strInstructions}</p>
            <h3 class="my-3">Ingredients y Ammounts</h3>
        `;
        ...
        btnFavorito.textContent = existeStorage(idMeal) ? 'Remove Favorite' : 'Add Favorite';
    ...
    function obtenerFavoritos() {
        ...
        noFavoritos.textContent = 'No favorites have been added';
